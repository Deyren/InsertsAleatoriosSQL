...
public class Datos {
    ...
    /**
     * Nombre que tiene el programa, que aparecerá en el titulo de la ventana. <br>
     */
    ...
    public static final String RUTA_DEL_XSD="C:\\Users\\pedruben\\Documents\\NetBeansProjects\\CreadorDeInsertsSQL\\src\\creadordeinsertssql\\gestiondearchivos\\EsquemaDeArchivoDeProyecto.xsd";
    ...
    */
    ...
    public static enum MenuDeArchivoEnEspañol{
     ...
     /**
      * Guarda un archivo de proyecto con 
      * los datos que contenga las tablas en ese momento. <br>
     ...
     /**
      * Devuelve un String con el contenido que debe tener 
      * el archivo XSD Schema para los XMLs del proyecto. <br>
      * @return 
      */
