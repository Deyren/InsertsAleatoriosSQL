 ...
 * Actualiza periodicamente el array de columnas de la clase Datos con los datos
 * de el objeto Columna que contiene. <br>
 *
 * @author Ruben
 */
public class VentanaColumna extends javax.swing.JPanel implements ActionListener {
     ...
     * en el combo de la tabla a la que apunta
     * Si el combo no esta Enabled devuelve
     *  un String vacio. <br>
     * @return 
     */
    public String getTextoTablaALaQueApunta() {
        if (comboTablaALaQueApunta.isEnabled()) {
            return comboTablaALaQueApunta.getSelectedItem().toString();
        } else {
            return "";
        }
    ...
    /**
     * Metodo de se ejecuta periodicamente actualizando la vista y el array de
     * Datos.tablas, <br>
     *
     * @param evt
     */
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (checkClaveAgena.isSelected()) {
            ...
            if (!comboTablaALaQueApunta.isEnabled()) {
                ...
                comboTablaALaQueApunta.setEnabled(true);
            ...
            if (comboTablaALaQueApunta.isEnabled()) {
                ...
                comboTablaALaQueApunta.setEnabled(false);
            }
        }
    ...
    /**
     * Busca en el array de tablas de la clase Datos el objeto Columna que sea
     * igual al objeto Columna que contiene esta clase, cuando lo encuentra
     * llama al metodo asignarValoresDeLaVistaASuColumna(Columna suColumna,
     * VentanaColumna ven) del gestor de columnas, le pasa el objeto Columna de
     * esta clase y null como segundo parametro.
     */
     ...
     * Llama al metodo actionPerformed de esta clase cada 'delay' milisegundos.
     * <br>
     ...
     * establece los campos del panel, como los valores de los ComboBox.
     */
    private void iniciarCampos() {
        ...
        textoValorMaximo.setEnabled(false);
        comboTablaALaQueApunta.setEnabled(false);
        comboTablaALaQueApunta.removeAllItems();
        comboTablaALaQueApunta.addItem(" ");
        String[] nombresDeTablas = Datos.nombresDeLasTablas();
        for (String nombresDeTabla : nombresDeTablas) {
            if (!nombresDeTabla.equals(gestor.getSuTabla().getNombre())) {
                comboTablaALaQueApunta.addItem(nombresDeTabla);
            }
        }
    ...
    private void initComponents() {
        ...
        comboTablaALaQueApunta = new javax.swing.JComboBox();
        ...
        comboTablaALaQueApunta.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        panelContenedorLayout.setHorizontalGroup(
            ...
            .addGroup(panelContenedorLayout.createSequentialGroup()
                ...
                .addGap(0, 0, Short.MAX_VALUE))
            .addComponent(comboTablaALaQueApunta, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        panelContenedorLayout.setVerticalGroup(
            ...
            .addGroup(panelContenedorLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(comboTablaALaQueApunta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private javax.swing.JComboBox comboTablaALaQueApunta;
